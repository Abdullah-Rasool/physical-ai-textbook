...
const sidebars = {
  tutorialSidebar: [
    ...
    {
      type: 'category',
      label: 'Module 5: Vision-Language-Action Integration',
      items: [
        'vla/index',
        'vla/vla-fundamentals',
        'vla/multimodal-perception',
    ...
    {
      type: 'category',
      label: 'Module 6: Capstone - End-to-End Humanoid AI',
      items: [
        'capstone/index',
        'capstone/system-overview',
        'capstone/module-connections',
        'capstone/reference-architecture',
        'capstone/system-concerns',
        'capstone/synthesis',
      ],
    },
  ],
